    ...
    <?php
        ...
        <?php
            if ($_SESSION['SHIP_USER_ROLE'] != 3) {
                    ?>
<a href="?party_id=<?php echo $partyID; ?>&&ledger_id=<?php echo $rowLedgerDetails['ledger_id']; ?>">Edit</a> || <a href="javascript:void(0)" onclick="confirmDeletion('<?php echo $rowLedgerDetails['ledger_id']; ?>')">Delete</a>
        <?php
            }
                ?>
        </td>
