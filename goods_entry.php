    ...
    <?php
        ...
        <?php
            if ($_SESSION['SHIP_USER_ROLE'] != 3) {
                    ?>
 <a href="?party_id=<?php echo $partyID; ?>&&goods_id=<?php echo $rowGoodsDetails['goods_id']; ?>">Edit</a> || <a href="javascript:void(0)" onclick="confirmDeletion('<?php echo $rowGoodsDetails['goods_id']; ?>')">Delete</a>
        <?php
            }
                ?>
       </td>
