                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" tabindex="1" class="form-control" name="manifest_no" id="manifest_no" placeholder="ENTER MANIFEST NO" onkeyup="search_shipment(this.value);" />
                                                </div>
            ...
            <script>
                function search_shipment(manifest_no) {
                    if (manifest_no === "") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "getAPI.php?search_unload_shipment",
                            dataType: "json",
                            data: {
